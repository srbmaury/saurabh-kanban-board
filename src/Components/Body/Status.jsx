...
const Status = ({type}) => {
    ...
    return (
        <div>
            {/* Backlog */}
            {type === "Backlog" && <svg  {...commonStyle} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" class="icon" >
            ...
            {/* Todo */}
            {type === "Todo" && <svg {...commonStyle} strokeWidth="2">
                <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path>
            </svg>}

            {/* In Progress */}
            {type === "In progress" && <svg {...commonStyle} style={{ color: 'rgb(245, 200, 66)' }}>
                <path d="M12 2h-1v9H2v1a10 10 0 0 0 17.07 7.07A10 10 0 0 0 12 2z"></path>
            </svg>}

            {/* Done */}
            {type === "Done" && <svg {...commonStyle} style={{ color: 'rgb(56, 75, 181)' }}>
            ...
            {/* Cancelled */}
            {type === "Cancelled" && <svg {...commonStyle}>
