...
const Navbar = () => {
    ...
    return (
        <div className={`px-6 py-3 flex justify-between items-center ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
            <Display />
            <div className="ml-auto cursor-pointer" onClick={toggleDarkMode}>
                {darkMode ? (
                    // sun icon
